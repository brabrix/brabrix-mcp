...
exports.showWorkflowArtifactCommand = showWorkflowArtifactCommand;
const vscode = require("vscode");
async function showWorkflowArtifactCommand(client, args) {
    try {
        const artifact = await client.getWorkflowArtifact(args.projectId, args.artifactId);
        const panel = vscode.window.createWebviewPanel('brabrixWorkflowArtifact', args.label, vscode.ViewColumn.One, { enableScripts: true });
...
//# sourceMappingURL=showWorkflowArtifactCommand.js.map